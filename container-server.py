...
def containers_index():
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8000/containers | python -mjson.tool
    curl -s -X GET -H 'Accept: application/json' http://localhost:8000/containers?state=running | python -mjson.tool
